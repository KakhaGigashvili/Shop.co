...
export default () => {
    return(
        ...
        <p className= {`${styles.integral}  mt-[10px] font-normal text-base `}>Already have an account? Login</p>
            </div>

        <Form labelCol={{span: 8}} wrapperCol={{span: 16}} style={{marginTop: '100px'}} >
      ...
      >
        <Input placeholder="Email" name="email" style={{height: '49px', width: '554px', border:'1px solid #04030899'}} />
      </Form.Item>
      ...
      <Form.Item>
        <Button type="primary" style={{ width: '554px', background: '#000000', height: '49px'}}> Create Account </Button>
      </Form.Item>
